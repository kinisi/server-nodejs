...
module.exports.googleSignInCallback = function googleSignInCallback(req, res, next) {
	...
	passport.authenticate('google', function(err, user, info) {
        ...
        db.query("SELECT id, a.token, oauth_token FROM api_token a JOIN oauth_token o ON a.id = o.user_id WHERE o.oauth_token = ? and o.oauth_service = 'google'", [user.token],
